...
public class FRM_VentanaPrincipal extends javax.swing.JFrame {
    ...
    public void agregarEventos()
    {
        ...
        this.jmNuevo.addActionListener(controlador_FRM_VentanaPrincipal);
    ...
    private void initComponents() {
        ...
        menuNuevoUsuario = new javax.swing.JMenu();
        ...
        menuNuevoUsuario.add(jmNuevo);

        jm_BarraMenu.add(menuNuevoUsuario);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
           ...
           if (metodos.existeArchivo())
           {
               metodos.cargardatosArchivo();
               FRM_MantenimientoLogin login = new FRM_MantenimientoLogin(metodos);
               login.setVisible(true);   
           }
           else 
           {
                FRM_MantenimientoUsuario usuario = new FRM_MantenimientoUsuario(new FRM_VentanaPrincipal());
    ...
    private javax.swing.JMenu menuNuevoUsuario;
